...
# 11 "ECU_Layer/RTC_DS1307/rtc_DS1307.h"
...
# 121 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 133 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/pin_manager.h"
...
# 1 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/examples/i2c_master_example.h" 1
# 54 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/examples/i2c_master_example.h"
...
# 74 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 87 "ECU_Layer/RTC_DS1307/../../mcc_generated_files/mcc.h"
void OSCILLATOR_Initialize(void);
# 11 "ECU_Layer/RTC_DS1307/rtc_DS1307.h" 2
...
RTC_DS1307_t RTC_DS1307_Read_Date(void);
void Print_Data_In_UART(void);
# 8 "ECU_Layer/RTC_DS1307/rtc_DS1307.c" 2

# 1 "ECU_Layer/RTC_DS1307/../UART_BY_ME/UART_String.h" 1
# 13 "ECU_Layer/RTC_DS1307/../UART_BY_ME/UART_String.h"
void UART_Write_String(uint8_t *Str);
# 9 "ECU_Layer/RTC_DS1307/rtc_DS1307.c" 2


static RTC_DS1307_t Obj;
static uint8_t RTC_Str[21] = {'\0'};

RTC_DS1307_t RTC_DS1307_Read_Date(void){
    Obj.Seconds = I2C_Read1ByteRegister(0xD0, 0x00);
    Obj.Minutes = I2C_Read1ByteRegister(0xD0, 0x01);
    Obj.hours = I2C_Read1ByteRegister(0xD0, 0x02);
    Obj.Days = I2C_Read1ByteRegister(0xD0, 0x04);
    Obj.Months = I2C_Read1ByteRegister(0xD0, 0x05);
    Obj.Year = I2C_Read1ByteRegister(0xD0, 0x06);

    return Obj;
}

void Print_Data_In_UART(void){
    RTC_Str[0] = ((Obj.Days >> 4) + '0');
    RTC_Str[1] = ((Obj.Days & 0x0F) + '0');
    RTC_Str[2] = '-';
    RTC_Str[3] = ((Obj.Months >> 4) + '0');
    RTC_Str[4] = ((Obj.Months & 0x0F) + '0');
    RTC_Str[5] = '-';
    RTC_Str[6] = ((Obj.Year >> 4) + '0');
    RTC_Str[7] = ((Obj.Year & 0x0F) + '0');
    RTC_Str[8] = ' ';
    RTC_Str[9] = ':';
    RTC_Str[10] = ' ';
    RTC_Str[11] = ((Obj.hours >> 4) + '0');
    RTC_Str[12] = ((Obj.hours & 0x0F) + '0');
    RTC_Str[13] = '-';
    RTC_Str[14] = ((Obj.Minutes >> 4) + '0');
    RTC_Str[15] = ((Obj.Minutes & 0x0F) + '0');
    RTC_Str[16] = '-';
    RTC_Str[17] = ((Obj.Seconds >> 4) + '0');
    RTC_Str[18] = ((Obj.Seconds & 0x0F) + '0');
    RTC_Str[19] = '\r';
    UART_Write_String(RTC_Str);
}
