...
# 13 "./ECU_Layer/RTC_DS1307/rtc_DS1307.h"
typedef struct{
    uint8_t Seconds;
    uint8_t Minutes;
    uint8_t hours;
...
# 13 "./ECU_Layer/UART_BY_ME/UART_String.h"
...
# 12 "./ECU_Layer/Temperature_TC74/TC74.h"
...
void main(void)
{
    ...
    UART_Write_String("Embedded System\r");
    UART_Write_String("Made By Mohammed\r");

    EEPROM_24C02C_Write_Data(0xA2, 0x03, 1);
    EEPROM_24C02C_Write_Data(0xA0, 0x03, 2);

    EEP_Data_1 = EEPROM_24C02C_Read_Data(0xA2, 0x03);
    EEP_Data_2 = EEPROM_24C02C_Read_Data(0xA0, 0x03);


    while (1)
    {
        Obj1 = RTC_DS1307_Read_Date();
        Print_Data_In_UART();

        Temp_TC74 = Temp_Read_Data(0x9A);
        I2C_Write1ByteRegister(0x70, 0x00, Temp_TC74);
